...
export async function deriveCurvePda(threadId) {
  return PublicKey.findProgramAddress(
    [threadIdBytes("curve"), threadIdBytes(threadId)],
    PROGRAM_ID,
  );
}
...
export async function deriveCurveAuthorityPda(threadId) {
  return PublicKey.findProgramAddress(
    [threadIdBytes("curve_authority"), threadIdBytes(threadId)],
    PROGRAM_ID,
  );
}
...
export async function deriveCurveTokenVaultPda(threadId) {
  return PublicKey.findProgramAddress(
    [threadIdBytes("curve_token_vault"), threadIdBytes(threadId)],
    PROGRAM_ID,
  );
}
...
export async function deriveMintPda(threadId) {
  return PublicKey.findProgramAddress(
    [threadIdBytes("mint"), threadIdBytes(threadId)],
    PROGRAM_ID,
  );
}
...
export async function deriveEscrowPda(threadId) {
  return PublicKey.findProgramAddress(
    [threadIdBytes("escrow"), threadIdBytes(threadId)],
    PROGRAM_ID,
  );
}
...
export async function deriveBanPda(threadId, userPubkey) {
  return PublicKey.findProgramAddress(
    [threadIdBytes("ban"), threadIdBytes(threadId), toPublicKey(userPubkey).toBuffer()],
    PROGRAM_ID,
  );
}
